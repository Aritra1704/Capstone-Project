...
public class DashboardActivity extends BaseActivity {
    ...
    public void initialize() {
        llFenceActivity = baseInflater.inflate(R.layout.activity_tabbed,null);
    ...
    private void initialiseControls(){
        ...
        mViewPager = (ViewPager) llFenceActivity.findViewById(R.id.container);
        mViewPager.setAdapter(mSectionsPagerAdapter);

        fab = (FloatingActionButton) llFenceActivity.findViewById(R.id.fab);
    }
}
